...
$callbackURL = 'http://localhost/bkash-payment-geteway';

$app_key ='0fVnKYaKdc8dzU1LKnGJMCoytc';
$app_secret ='LggUx1fVhkZvamCIpNDnvN6doGgMuvMlwbth41ipZnfq1vuRmFFD';
$username ='01963841630';
$password ='w%7.HKG.efW';
...
if (isset($_GET['paymentID'],$_GET['status'])) {
    ...
    if (isset($obj->transactionStatus) && $obj->transactionStatus == 'Completed') {
        ...
        if (isset($obj->statusMessage)) {
            echo "<p>Error: " . $obj->statusMessage . "</p>";
        }
    }
}
